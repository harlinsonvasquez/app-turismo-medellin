...
class PlaceProvider extends ChangeNotifier {
  ...
  Future<void> loadPlaces({Map<String, dynamic>? query}) async {
    isLoading = true;
    error = null;
    notifyListeners();
    try {
      places = await _placeService.fetchPlaces(query: query);
  ...
  Future<PlaceModel?> loadPlaceDetail(String id) async {
    try {
