              ...
              children: [
                Container(
                  ...
                  child: const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Bienvenido de vuelta', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w800)),
                      SizedBox(height: 8),
                      Text('Guarda favoritos, sincroniza tus planes y usa el backend real de AppTurismo.', style: TextStyle(color: Colors.white70, height: 1.4)),
                    ],
                  ),
                ),
                ...
                GradientButton(
                  ...
                  onPressed: () async {
                    ...
                    final ok = await context.read<AuthProvider>().login(_emailController.text.trim(), _passwordController.text.trim());
                    if (!mounted) return;
