...
/// Consolida los datos persistidos del usuario.
/// La pestaña de favoritos consume `/api/favorites` y la de itinerarios
/// consulta `/api/itineraries`.
                        ...
                        return Container(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Padding(
                              ...
                              child: Text(
                                  '${plan.days} dias • ${plan.estimatedTotal}',
                                  style: const TextStyle(
                                      fontSize: 12,
