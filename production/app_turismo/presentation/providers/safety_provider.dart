...
/// Administra la consulta de consejos de seguridad consumidos desde
/// `/api/safety-tips`.
class SafetyProvider extends ChangeNotifier {
  ...
  Future<void> cargarConsejos({String city = 'Medellin', String? zone}) async {
    isLoading = true;
    error = null;
    notifyListeners();
    try {
      tips =
          await _safetyService.obtenerConsejosSeguridad(city: city, zone: zone);
  ...
  Future<void> loadTips({String city = 'Medellin', String? zone}) =>
      cargarConsejos(city: city, zone: zone);
}
