...
/// Presenta el itinerario generado o recuperado desde el backend y permite
/// persistirlo para el usuario autenticado.
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${plan.days} dias • ${plan.estimatedTotal}',
                        ...
                        if (isExpanded)
                          Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...dayPlan.morning.map((item) => Text(
                                    'Manana: ${item.title} - ${item.estimatedCost}')),
                                ...dayPlan.afternoon.map((item) => Padding(
                                    padding: const EdgeInsets.only(top: 8),
                                    child: Text(
                                        'Tarde: ${item.title} - ${item.estimatedCost}'))),
                                ...dayPlan.night.map((item) => Padding(
                                    padding: const EdgeInsets.only(top: 8),
                                    child: Text(
                                        'Noche: ${item.title} - ${item.estimatedCost}'))),
                              ],
                            ),
                          ),
                      ],
                ...
                onPressed: () async {
                  ...
                  if (saved != null) {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                        content: Text('Itinerario guardado con exito')));
                  }
                },
