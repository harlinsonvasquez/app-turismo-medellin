...
class _BusinessPromoScreenState extends State<BusinessPromoScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
        (_) => context.read<MembershipProvider>().loadPlans());
  }
          ...
          children: [
            Container(
              ...
              child: const Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Llega a mas turistas en Medellin',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 24,
                  ...
                  SizedBox(height: 8),
                  Text(
                      'Los planes y beneficios ahora vienen directamente del backend y quedan listos para un panel web futuro.',
                      style: TextStyle(color: Colors.white70, height: 1.4)),
                ],
              ),
            ),
            const SizedBox(height: 24),
            Text('Planes de membresia',
              ...
              ...provider.plans.map((plan) => Padding(
                    ...
                    child: MembershipPlanCard(
                      ...
                      onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text(
                                  'Seleccionaste ${plan.name}. Integracion comercial lista para el siguiente paso.'))),
                    ),
                  )),
