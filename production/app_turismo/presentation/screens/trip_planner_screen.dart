...
/// Pantalla que recoge la entrada del usuario para generar un itinerario.
/// Consume el endpoint `/api/itineraries/generate`.
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Text(
                        'Cuenta como viajas y el backend genera un itinerario real con datos persistidos.',
                  ...
                  _SectionLabel(
                      ...
                      value: '\$${(_budget / 1000).toStringAsFixed(0)}K COP'),
                  Slider(
                      value: _budget,
                      min: 100000,
                      max: 2000000,
                  ...
                  const SizedBox(height: 24),
                  _SectionLabel(
                      label: 'Con quien viajas', value: _travelerType.name),
                  const SizedBox(height: 12),
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: TravelerType.values.map((traveler) {
                      ...
                      return AppChip(
                          ...
                          isSelected: selected,
                          onTap: () =>
                              setState(() => _travelerType = traveler));
                    }).toList(),
                  ),
                  const SizedBox(height: 24),
                  _SectionLabel(
                  ...
                  if (!auth.isAuthenticated)
                    Padding(
                      ...
                      child: Text(
                          'Puedes generar sin login, pero para guardar el plan necesitas iniciar sesion.',
                          style: TextStyle(
                  ...
                  if (itineraryProvider.error != null)
                    Padding(
                      padding: const EdgeInsets.only(top: 24),
                      child: Text(itineraryProvider.error!,
          ...
          Container(
            padding: const EdgeInsets.fromLTRB(AppConstants.paddingM,
                AppConstants.paddingM, AppConstants.paddingM, 32),
            ...
            child: GradientButton(
              ...
              onPressed: () async {
                final plan =
                    await context.read<ItineraryProvider>().generarPlan(
                          PlanInputModel(
                            city: 'Medellin',
                            days: _days,
